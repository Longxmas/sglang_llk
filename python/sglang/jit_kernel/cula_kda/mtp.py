# NOTE: Vendored from cuLA (cula/ops/kda/decode/mtp.py). Host-side helpers are
# imported from the sibling `_common` module; there is no dependency on the
# `cula` package. Kernel bodies are copied verbatim.
