# NOTE: Vendored from cuLA (cula/ops/kda/decode/mtp_kvbuffer.py). Host-side
# helpers come from the sibling `_common` module and `.mtp`; there is no
# dependency on the `cula` package. Kernel bodies are copied verbatim.
